...
public struct CurrencyTextField: UIViewRepresentable {
    ...
    public func makeUIView(context: UIViewRepresentableContext<CurrencyTextField>) -> UITextField {
        ...
        // initial value
        if let v = self.value {
            textField.text = v.currencyFormat(decimalPlaces: self.numberOfDecimalPlaces, forceShowDecimalPlaces: self.alwaysShowFractions, currencySymbol: "$")
        }
    ...
    public class Coordinator: NSObject, UITextFieldDelegate {
        ...
        public func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
            ...
            let display = newValue?.currencyFormat(decimalPlaces: self.numberOfDecimalPlaces, currencySymbol: "$")
